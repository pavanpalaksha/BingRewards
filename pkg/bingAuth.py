...
# get url to post data to
        ...
        url = "https://www.bing.com/secure/Passport.aspx?requrl=http%3a%2f%2fwww.bing.com%2f%3fwlexpsignin%3d1%26wlexpsignin%3d1&wa=wsignin1.0"
        request = urllib2.Request(url, postFields, self.httpHeaders)
        ...
        request = urllib2.Request(url, postFields, self.httpHeaders)
        request.add_header("Referer", "https://www.bing.com/secure/Passport.aspx?requrl=http%3a%2f%2fwww.bing.com%2f%3fwlexpsignin%3d1%26wlexpsignin%3d1&wa=wsignin1.0")
        with self.opener.open(request) as response:
            url = response.geturl()
